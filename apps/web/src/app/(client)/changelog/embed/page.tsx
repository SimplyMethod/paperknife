...
export default function Page() {
  const [contentWithPreferredLanguage, setContentWithPreferredLanguage] = useState(posts);

  useEffect(() => {
    window.addEventListener('message', (e) => {
      if (e.data.type === 'widgetStatus') {
        if (e.data.active) {
  ...
  useEffect(() => {
    const acceptLanguage = window.navigator.language;
    ...
    setContentWithPreferredLanguage(contentWithPreferredLanguage);
  }, []);
